function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 p-4 sm:p-4 md:p-8 sm:max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
      <img
        src="/profile.png"
        alt="User"
